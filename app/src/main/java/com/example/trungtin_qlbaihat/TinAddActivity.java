...
public class TinAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tin_add_activity);
    ...
    private void addEvent() {
        ...
        btnHuy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TinAddActivity.this, TinMainActivity.class);
    ...
    private void insert() {
        ...
        database = Database.initDatabase(TinAddActivity.this, DATABASE_NAME);
        database.insert("TrungTin_BaiHat", null, contentValues);
