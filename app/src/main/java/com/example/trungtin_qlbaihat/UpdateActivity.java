...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tin_update_activity);
    ...
    private void addEvent() {
        ...
        btnHuy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UpdateActivity.this, TinMainActivity.class);
    ...
    private void update() {
        ...
        database.update("TrungTin_BaiHat", contentValues, " ID = ?", new String[] {idBH + ""});
